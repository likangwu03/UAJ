...
vector<_ecs::DishInfo> DailyMenuComp::randomMenu()
{
	...
	int t; // cleon: arriba las variables descriptivas. no lo copio, pero lo pienso.
	int i = 0;
	...
	for (; i < menuSize; i++) { // cleon: bienvenidos a 1971. Si os coge el de EDA os mata. y yo ayudo.
